...
public abstract class Conta {
	...
	public boolean equals(Object obj) {
		...
		// Se a referencia passada nao for uma instancia de Conta pelo menos, nao eh igual
		if (!(obj instanceof Conta))
			return false;

		// Agora que garantimos que a referencia passada eh de Conta, podemos fazer o casting.
